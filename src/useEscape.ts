 ...
 * sheet was on a phone, where the key does not exist and the only way back was
 * a 30px ring in a corner. Anything that covers the screen gets both — this,
 * and something to tap away from.
 */
